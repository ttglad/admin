...
<head>
    <meta charset="UTF-8">
    <title>@section('title') 后台 - 系统 @show{{-- 页面标题 --}}</title>
    <meta name="description" content="{{ isset($description) ? $description : '后台' }}" />
    <meta name="keywords" content="后台,{{ cache('website_keywords') }}" />
